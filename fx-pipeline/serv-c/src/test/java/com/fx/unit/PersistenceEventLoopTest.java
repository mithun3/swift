...
class PersistenceEventLoopTest {
    ...
    void setUp() throws Exception {
        ...
        loop = new PersistenceEventLoop(JDBC_URL, null, null, null, null, null, null, null);
    ...
    void testConstructorWithNullTelemetryDoesNotThrow() throws Exception {
        ...
        try (final PersistenceEventLoop nullLoop = new PersistenceEventLoop(url, null, null, null, null, null, null, null)) {
